...
public class User extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final long serialVersionUID = 4597343961582061785L;
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
			"{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"com.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favoriteNumber\",\"type\":[\"int\",\"null\"]},{\"name\":\"favoriteColor\",\"type\":[\"string\",\"null\"]}]}");
	...
	public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
		...
		if (fieldOrder == null) {
			...
			if (in.readIndex() != 0) {
				...
				this.favoriteColor = in
						.readString(this.favoriteColor instanceof Utf8 ? (Utf8) this.favoriteColor : null);
			}
